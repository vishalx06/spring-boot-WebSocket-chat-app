...
/*
In this step we define event listeners for the connection or disconnection of client or user with our
WebSocket server so that we can log these events and also broadcast them in a group chat when the user joins or leave the group.
*/
